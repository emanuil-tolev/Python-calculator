...
B0 = Tkinter.Button(top, text='0')
B0.grid(row='3', column='1')

# Now the buttons for the mathematical operations.

B10 = Tkinter.Button(top, text='*')
B10.grid(row='0', column='3')
B11 = Tkinter.Button(top, text='/')
B11.grid(row='1', column='3')
B12 = Tkinter.Button(top, text='-')
B12.grid(row='2', column='3')
B13 = Tkinter.Button(top, text='+')
B13.grid(row='3', column='3')
B14 = Tkinter.Button(top, text='=')
B14.grid(row='3', column='2')
B15 = Tkinter.Button(top, text='.')
